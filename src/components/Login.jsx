                ...
                <div className="hero-content flex-col ">
                    ...
                    <div className="card flex-shrink-0 w-[35rem] shadow-2xl bg-base-100">
                        ...
                        <div className='flex flex-col gap-3 ml-8'>
                            ...
                            <button className=' w-[10rem] h-[2rem] rounded justify-center flex items-center text-sm bg-stone-800 text-white '> <FaGithub className='mr-2' /> SignIn With GitHub</button>
